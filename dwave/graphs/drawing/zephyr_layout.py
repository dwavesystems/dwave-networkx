...
def zephyr_layout(G, scale=1., center=None, dim=2):
    ...
    G : NetworkX graph
        ...
        the :func:`dwave.graphs.zephyr_graph` function.
    ...
    >>> pos = dwave.graphs.zephyr_layout(G)

    """

    if not isinstance(G, nx.Graph) or G.graph.get("family") != "zephyr":
        raise ValueError("G must be generated by dwave.graphs.zephyr_graph")
...
def draw_zephyr(G, **kwargs):
    ...
    >>> G = dwave.graphs.zephyr_graph(2)
    >>> dwave.graphs.draw_zephyr(G)    # doctest: +SKIP
