...
from dwave.plugins.networkx.generators.pegasus import pegasus_graph, pegasus_coordinates
from dwave.plugins.networkx.drawing.chimera_layout import chimera_node_placer_2d
...
def pegasus_layout(G, scale=1., center=None, dim=2, crosses=False):
    ...
    G : NetworkX graph
        ...
        the :func:`dwave.plugins.networkx.pegasus_graph` function.
    ...
    if not isinstance(G, nx.Graph) or G.graph.get("family") != "pegasus":
        raise ValueError("G must be generated by dwave.plugins.networkx.pegasus_graph")
